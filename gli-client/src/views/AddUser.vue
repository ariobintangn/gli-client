...
<template>
    ...
    <section class="container border mt-5 p-3" style="width: 400px">
        ...
        <form id="login-form" @submit.prevent="registerHandlerComponent" >
            ...
            <input required type="text" class="form-control" id="exampleUsername" aria-describedby="emailHelp" placeholder="ex: johndoe" v-model="add_name">
            </div>
            <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Email</label>
            <input required type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="someone@mail.com" v-model="add_email">
            </div>
            <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Alamat</label>
            <input required type="text" class="form-control" id="exampleInputPassword1" placeholder="alamat" v-model="add_alamat">
            </div>
            <div class="mb-3">
            <label for="examplePhone" class="form-label">Tanggal Lahir</label>
            <input required type="date" class="form-control" id="examplePhone" aria-describedby="emailHelp" placeholder="0813xxxx" v-model="add_tanggal_lahir">
            </div>
            <div class="mb-3">
            <label for="exampleAddress" class="form-label">Jenis Kelamin</label>
            <!-- <input required type="select" class="form-control" id="exampleAddress" aria-describedby="emailHelp" placeholder="jl. perintis kemerdekaan .... " v-model="add_jenis_kelamin"> -->
